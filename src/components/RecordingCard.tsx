...
import { Calendar, CalendarIcon, Clock, ClockIcon, CopyIcon, PlayIcon } from 'lucide-react';
      ...
      <CardHeader className='space-y-1'>
        <div className='space-y-2'>
          <div className='flex flex-col gap-1.5'>
            <div className='fkex items-center text-sm text-muted-foreground gap-2'>
              <CalendarIcon className='h-2.5 w-3.5'/>
